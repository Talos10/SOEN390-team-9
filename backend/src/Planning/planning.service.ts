import { Event as EventModel, Goal as GoalModel } from './planning.models';
...
class Service {
    ...
    public async getAllEvents(): Promise<ReturnMessage> {
        try {
            ...
            logger.error(`Failed to get all events`, ['event', 'find', 'failed'], e.message);
    ...
    public async addEvent(event: EventModel): Promise<ReturnMessage> {
        try {
            ...
            logger.error(`Failed to add event ${event}`, ['event', 'add', 'failed'], e.message);
    ...
    public async getAllGoals(): Promise<ReturnMessage> {
        try {
            ...
            logger.error(`Failed to get all goals`, ['goal', 'add', 'failed'], e.message);
    ...
    public async addGoal(goal: GoalModel): Promise<ReturnMessage> {
        try {
            ...
            logger.error(`Failed to add goal ${goal}`, ['goal', 'add', 'failed'], e.message);
