...
INSERT `raw_material` (`raw_material_id`, `raw_material_name`, `quantity`, `price`, `vendor`) VALUES(null, "carbon fiber", 5, 5, "Maxon Factory");
INSERT `raw_material` (`raw_material_id`, `raw_material_name`, `quantity`, `price`, `vendor`) VALUES(null, "steel", 10, 20, "Steelworks Laval");
INSERT `raw_material` (`raw_material_id`, `raw_material_name`, `quantity`, `price`, `vendor`) VALUES(null, "rubber", 7, 23, "Rubber.co");
INSERT `raw_material` (`raw_material_id`, `raw_material_name`, `quantity`, `price`, `vendor`) VALUES(null, "leather", 5, 50.69, "Tanning Frank");

INSERT `semi_finished_good` (`semi_finished_good_id`, `semi_finished_good_name`, `quantity`, `price`, `vendor`) VALUES(null, "blue paint", 4, 10.52, "Value Paint");
INSERT `semi_finished_good` (`semi_finished_good_id`, `semi_finished_good_name`, `quantity`, `price`, `vendor`) VALUES(null, "bike seat", 2, 20.20, null);
INSERT `semi_finished_good` (`semi_finished_good_id`, `semi_finished_good_name`, `quantity`, `price`, `vendor`) VALUES(null, "carbon frame", 3, 80.50, null);
INSERT `semi_finished_good` (`semi_finished_good_id`, `semi_finished_good_name`, `quantity`, `price`, `vendor`) VALUES(null, "rubber tire", 4, 50.37, null);
INSERT `semi_finished_good` (`semi_finished_good_id`, `semi_finished_good_name`, `quantity`, `price`, `vendor`) VALUES(null, "steel wheel frame", 4, 44.10, null);
INSERT `semi_finished_good` (`semi_finished_good_id`, `semi_finished_good_name`, `quantity`, `price`, `vendor`) VALUES(null, "steel bike handles", 2, 24.78, null);
INSERT `semi_finished_good` (`semi_finished_good_id`, `semi_finished_good_name`, `quantity`, `price`, `vendor`) VALUES(null, "bike gears", 3, 70.25, null);
INSERT `semi_finished_good` (`semi_finished_good_id`, `semi_finished_good_name`, `quantity`, `price`, `vendor`) VALUES(null, "steel breaks", 2, 49.36, null);

INSERT `finished_good` (`finished_good_id`, `finished_good_name`, `quantity`, `price_of_construction`, `price_of_selling`, `archived`) VALUES(null, "le sebastien", '1', 682.85, 1245.99, 0);

INSERT `customer_order` (`customer_order_id`, `status`, `price`) VALUES(null, "awaiting fulfillment", 1245.99);

INSERT `production_order` (`production_order_id`, `status`, `price`) VALUES(null, "completed", 4.23);
INSERT `production_order` (`production_order_id`, `status`, `price`) VALUES(null, "completed", 14.01);
...
INSERT `ordered_finished_by_customer` VALUES(1, 1, 1, 1245.99);

INSERT `ordered_finished_by_production` VALUES(1, 1, 1, 1245.99);

INSERT `ordered_raw_material` VALUES(1, 1, 1, 4.23);

INSERT `ordered_semi_finished` VALUES(2, 1, 1, 14.01);

INSERT `property_of_raw_material` VALUES(4, "leather quality", "full-grain");

INSERT `property_of_semi_finished_good` VALUES(3, "size", "18");
INSERT `property_of_semi_finished_good` VALUES(3, "finish", "chrome");
INSERT `property_of_semi_finished_good` VALUES(7, "number of speeds", "12");

INSERT `property_of_finished_good` VALUES(1, "color", "blue");
INSERT `property_of_finished_good` VALUES(1, "size", "medium");
